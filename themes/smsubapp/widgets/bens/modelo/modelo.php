...
<div class="col-xl-12">
    <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="container-fluid">
                        <div class="d-flex justify-content-center">
                            <div class="col-12">
                                <form class="row gy-2 gx-3 align-items-center needs-validation" novalidate action="<?= url("/beta/patrimonio/modelos/cadastrar"); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-1">
                                            ...
                                            <input type="text" data-bs-togglee="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" 
                                                ...
                                                name="modelo_nome" placeholder="NOME">
        ...
        <?php else: ?>
            ...
            <div class="card-header text-center fw-bold fs-6 pt-1 pb-1 text-<?=CONF_APP_COLOR?>"><i class="bi bi-person"></i>   <?=CONF_SITE_NAME?> 2024 - modelos - ID <?=$modelos->id?></div>
                <div class="card-body">
                    <div class="container-fluid">
                        <div class="d-flex justify-content-center">
                            <div class="col-12">
                                <form class="row gy-2 gx-3 align-items-center needs-validation" novalidate action="<?= url("/beta/patrimonio/modelos/editar/{$modelos->id}"); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="action" value="update"/>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-1">
                                            ...
                                            <input type="text" data-bs-togglee="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" 
                                                data-bs-title="Nome" class="form-control form-control-sm"
                                                name="modelo_nome" placeholder="NOME" value="<?=$modelos->modelo_nome?>">
                                    ...
                                    <div class="row">   
                                        ...
                                        <div class="col-md-6 mb-1">
                                            ...
                                            <input type="text" data-bs-togglee="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" 
                                                data-bs-title="Descrição" class="form-control form-control-sm"
                                                name="descricao" placeholder="DESCRIÇÃO" id="descricao" value="<?=$modelos->descricao?>" >
                                        </div>
                                    ...
                                    <div class="row justify-content-center mt-4 mb-3">
                                        <div class="col-auto">
                                            <button data-bs-togglee="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                                                data-bs-title="Clique para atualizar a modelo" class="btn btn-sm btn-outline-success fw-bold me-2"><i class="bi bi-disc-fill me-2"></i>ATUALIZAR</button>
                                            <a href="<?=url("/beta/patrimonio/modelos/lista")?>" role="button" data-bs-togglee="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                                            data-bs-title="Clique para listar as modelos" class="btn btn-sm btn-outline-smsub fw-bold me-2"><i class="bi bi-list me-2"></i>LISTAR</a>
                                            <a href="#" class="btn btn-sm btn-outline-danger fw-bold me-2"
                                            data-post="<?= url("/beta/patrimonio/modelos/editar/{$modelos->id}"); ?>"
                                            data-action="delete"
                                            ...
                                            data-user_id="<?= $modelos->id; ?>"><i class="bi bi-trash me-2"></i>Excluir</a>
                                        </div>
                                    </div>
                                </form>
