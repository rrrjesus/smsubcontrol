...
<?= $this->insert("views/theme/breadcrumb"); ?>
    ...
    <div class="card mb-4">
        <div class="card-header text-center fw-bold fs-6 pt-1 pb-1 text-<?=CONF_APP_COLOR?>"><i class="bi bi-person"></i>   <?=CONF_SITE_NAME?> 2024 - MODELOS</div>
        <div class="card-body">
            <div class="container-fluid">

                <div class="row justify-content-center mt-4 mb-3">
                    <div class="col-auto">
                        <a href="<?= url("/beta/patrimonio/modelos/cadastrar"); ?>" role="button" aria-disabled="false" data-bs-togglee="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                ...
                <table id="modelo" class="table table-hover table-bordered table-sm border-<?=CONF_WEB_COLOR?> p-2" style="width:100%">
                    ...
                    <tr>
                        ...
                        <td class="text-center fw-semibold"><?=(!empty($lista->modelo_nome) ? $lista->modelo_nome : "")?></td>
