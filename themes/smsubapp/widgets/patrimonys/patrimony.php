                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-1">
                            <div class="col-4 mb-1">
                                ...
                                <input class="form-control form-control-sm" data-bs-togglee="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip-<?=color_month()?>" 
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-1">
                            ...
                            <div class="col-2 mb-1">
                                <label class="col-form-label col-form-label-sm" for="inputMovimentacao"><i class="bi bi-person-add me-1"></i><strong>Estado</strong></label>
                                <input tabindex="2" type="text" data-bs-togglee="tooltip" autofocus data-bs-placement="top" data-bs-custom-class="custom-tooltip-<?=color_month()?>" 
