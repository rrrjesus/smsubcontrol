$(function() {
    ...
    new DataTable('#events', {
        ...
        layout: {
            topStart: {
                buttons: [
                    {extend:'copy',title:'Eventos',header: 'Eventos',filename:'Eventos',className: 'btn btn-outline-primary btn-sm mt-3',text:'<i class="bi bi-copy"></i>' },
                    //{extend: 'pdf',exportOptions: {columns: ':visible'},title:'Eventos',header: 'Eventos',filename:'Eventos',orientation: 'portrait',pageSize: 'LEGAL',className: 'btn btn-outline-danger btn-sm mt-3',text:'<i class="bi bi-file-earmark-pdf"></i>'},
                    {extend:'excel',title:'Eventos',header: 'Eventos',filename:'Eventos',className: 'btn btn-outline-success btn-sm mt-3',text:'<i class="bi bi-file-earmark-excel"></i>' },
                    {extend:'print', exportOptions: {columns: ':visible'},title:'Eventos',header: 'Eventos',filename:'Eventos',orientation: 'portrait',className: 'btn btn-outline-secondary btn-sm mt-3',text:'<i class="bi bi-printer"></i>'},
    ...
    new DataTable('#churches', {
        buttons: [
            ...
            {extend: 'pdf',exportOptions: {columns: ':visible'},title:'Igrejas',header: 'Igrejas',filename:'Igrejas',orientation: 'portrait',pageSize: 'LEGAL',className: 'btn btn-outline-danger btn-sm mt-3',text:'<i class="bi bi-file-earmark-pdf"></i>'},
