        ...
        <div class="row">
            <div class="col-lg-3 mb-3">
                ...
                <ul class="list-unstyled small">
                    ...
                    <li class="mb-2">Código Fonte <a data-bs-togglee="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip" data-bs-title="GitHub do Desenvolvedor" class="text-decoration-none text-<?=color_month();?> fw-bold" href="https://github.com/rrrjesus/smsubcontrol" target="_blank" rel="noopener"><i class="bi bi-github"></i> @rrrjesus/smsubcontrol</a>.</li>
                </ul>
            </div>
            ...
            <div class="col-lg-2 mb-3">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2"><a data-bs-togglee="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip" data-bs-title="Acessar Home"  class="text-decoration-none text-<?=color_month();?> fw-bold" href="<?= url(); ?>">Home</a></li>
                    <li class="mb-2"><a data-bs-togglee="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip" data-bs-title="Acessar Contatos" class="text-decoration-none text-<?=color_month();?> fw-bold" href="<?= url("/contatos"); ?>">Contatos</a></li>
                    <li class="mb-2"><a data-bs-togglee="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip" data-bs-title="Acessar Sobre" class="text-decoration-none text-<?=color_month();?> fw-bold" href="<?= url("/sobre"); ?>">Sobre</a></li>
<!--                    <li class="mb-2"><a data-bs-togglee="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip" data-bs-title="Acessar Blog" class="text-decoration-none text-<?=color_month();?> fw-bold" href="http://10.23.237.79/blog">Blog</a></li>-->
                    <?php if(!empty($user->id)):?>
                        <li class="mb-2"><a data-bs-togglee="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip" data-bs-title="Acessar Painel" class="text-decoration-none text-<?=color_month();?> fw-bold" href="<?= url("/dashboard"); ?>">Painel</a></li>
                    <?php else: ?>
                        <li class="mb-2"><a data-bs-togglee="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip" data-bs-title="Login no Painel" class="text-decoration-none text-<?=color_month();?> fw-bold" href="<?= url("/entrar"); ?>">Entrar</a></li>
                    <?php endif;?>
                </ul>
            </div>
            ...
            <div class="col-12 col-lg-4 mb-3">
                ...
                <ul class="list-unstyled small">
                    ...
                    <li class="mb-2"><p><b>E-mail:</b><br>
                            <a class="text-decoration-none text-<?=color_month();?> fw-bold" href="mailto:<?=CONF_SITE_EMAIL?>" data-bs-togglee="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip" data-bs-title="E-mail de COTI - Suporte"><?=CONF_SITE_EMAIL?></a></p></li>
                    <li class="mb-2"><p><b>Endereço:</b><br><a class="text-decoration-none text-<?=color_month();?> fw-bold" data-bs-togglee="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip" data-bs-title="Endereço no Google Maps de SMSUB"  target="_blank" href="https://www.google.com/maps/place/Condom%C3%ADnio+do+Edif%C3%ADcio+Martinelli/@-23.5455906,-46.6350075,15z/data=!4m6!3m5!1s0x94ce5854575bec47:0xcff6dbd0a9dd6bac!8m2!3d-23.5455906!4d-46.6350075!16s%2Fm%2F047d5rn?entry=ttu">
