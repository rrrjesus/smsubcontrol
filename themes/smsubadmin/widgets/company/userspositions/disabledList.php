        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-center">
                <div class="col-12">
                    ...
                    <table id="userspositionsDisabled" class="table table-bordered table-sm border-secondary table-hover" style="width:100%">
                        ...
                        <tr>
                            <td class="text-center fw-semibold"><a href="<?= url("/painel/patrimonio/marcas/editar/{$lista->id}"); ?>" 
