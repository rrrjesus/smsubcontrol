...
<div class="col-md-12 ml-auto mt-3"> <!-- https://getbootstrap.com/docs/4.0/layout/grid/#mix-and-match -->
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-chevron p-2 bg-body-tertiary rounded-3">
            ...
            <li class="breadcrumb-item"><a class="link-body-emphasis fw-semibold text-decoration-none text-<?=CONF_ADMIN_COLOR?>" href="<?=url("/igrejas")?>"><i class="bi bi-building"></i> Igrejas</a></li>
            <li class="breadcrumb-item fw-semibold active" aria-current="page"><i class="bi bi-list"></i> <?php

 if(!empty($churche->id)): echo "Editar ".$churche->churche_name; else : echo "Cadastrar"; endif;?></li>
        </ol>
    </nav>
</div>
                ...
                <div class="card-body">
                    <div class="container-fluid">
                        <div class="d-flex justify-content-center">
                            <div class="col-12">
                                <form class="row gy-2 gx-3 align-items-center needs-validation" novalidate id="churche-register" action="<?=url("/igrejas/adicionar")?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-3 mb-1">
                                            <label class="col-form-label col-form-label-sm" for="inputSetor"><strong><i class="bi bi-building ms-3 me-3"></i> Igreja</strong></label>
                                            <input type="text" data-bs-togglee="tooltip" data-bs-placement="left" data-bs-custom-class="custom-tooltip" 
                                                data-bs-title="Digite o nome do igreja" class="form-control form-control-sm" name="churche_name" placeholder="Igreja">
                                        </div>
                                    ...
                                    <div class="row justify-content-center mt-4 mb-3">
                                        <div class="col-auto">
                                            ...
                                            <a href="<?=url("/igrejas")?>" data-bs-togglee="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip"
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="container-fluid">
                    <div class="d-flex justify-content-center">
                        <div class="col-12">
                            <form class="row gy-2 gx-3 align-items-center needs-validation" novalidate id="collaborator-edit" action="<?=url("/igrejas/editar/{$churche->id}")?>" method="post" enctype="multipart/form-data">
                                ...
                                <?=csrf_input();?>
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-md-3 mb-1">
                                            <label class="col-form-label col-form-label-sm" for="inputSetor"><strong><i class="bi bi-building ms-3 me-3"></i> Igreja</strong></label>
                                            <input type="text" value="<?=$churche->churche_name?>" data-bs-togglee="tooltip" data-bs-placement="left" data-bs-custom-class="custom-tooltip" 
                                                data-bs-title="Digite o nome do igreja" class="form-control form-control-sm" name="churche_name" placeholder="Igreja">
                                        </div>
                                        ...
                                        <div class="col-md-3 mb-1">
                                            ...
                                            <select class="form-control form-control-sm" data-bs-togglee="tooltip" data-bs-placement="left" data-bs-custom-class="custom-tooltip" 
                                            data-bs-title="Digite o status" name="status" id="status">
                                                <option value="disabled"<?php if ($churche->status == "disabled") {echo 'selected';}?>>Inativo</option>
                                                <option value="actived"<?php if ($churche->status == "actived") {echo 'selected';}?>>Ativo</option>
                                            </select>
                                        </div>
