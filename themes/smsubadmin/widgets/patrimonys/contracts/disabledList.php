    ...
    <div class="d-flex justify-content-center">
        <div class="col-12">
            <table id="brandsDisabled" class="table table-bordered table-sm border-secondary table-hover" style="width:100%">
                ...
                <tr>
                    <td class="text-center fw-semibold"><a href="<?= url("/beta/patrimonio/contratos/editar/{$lista->id}"); ?>" role="button" aria-disabled="true" data-bs-togglee="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip"
