        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-center break">
                <div class="card mt-2" style="width: 26rem; height:39rem">
                    <div class="card-header bg-<?=$user->group()->background_color?> fw-semibold text-<?=$user->group()->text_color;?> text-center text-uppercase">PROJETO RESGATE JAÇANÃ</div>
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center mb-1 mt-1">
                                ...
                                <div class="col-9 text-center ps-0 pe-0">
                                    ...
                                    <p class="h6 mt-0 mb-0 ms-1 text-uppercase" style="font-size: 20px;font-weight: 800">GT <?=$user->group_id?> - <?=mb_substr($user->group()->group_name, 0, 12, 'UTF-8' );?> </p>
                    ...
                    <div class="card-footer bg-<?=$user->group()->background_color?> fw-semibold text-<?=$user->group()->text_color;?> text-center text-uppercase">
                        GT <?=$user->group_id?> - <?=mb_substr($user->group()->group_name, 0, 12, 'UTF-8' );?>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-center break">
                <div class="card mt-2 mb-2" style="width: 26rem; height:39rem">
                    <div class="card-header bg-<?=$user->group()->background_color?> fw-semibold text-<?=$user->group()->text_color;?> text-center text-uppercase">
                        PROJETO RESGATE JAÇANÃ
                    </div>
                    <div class="card-body">
                        <div class="row justify-content-center mb-1 mt-0">
                            <div class="col-md-12 mb-0 text-center">
